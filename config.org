...
* Quick install
#+BEGIN_SRC 
git clone --depth=1 https://github.com/snackon/Witchmacs ~/.emacs.d && git clone --depth=1 https://github.com/radian-software/straight.el ~/.emacs.d/straight/repos/straight.el
#+END_SRC
