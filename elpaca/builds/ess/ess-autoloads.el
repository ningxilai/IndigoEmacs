...

;;; Generated autoloads from lisp/obsolete/ess-eldoc.el

(register-definition-prefixes "lisp/obsolete/ess-eldoc" '("ess-use-eldoc"))


;;; Generated autoloads from lisp/obsolete/ess-font-lock.el

(register-definition-prefixes "lisp/obsolete/ess-font-lock" '("ess-font-lock-"))
...

;;; Generated autoloads from lisp/obsolete/ess-mouse.el

(register-definition-prefixes "lisp/obsolete/ess-mouse" '("ess-"))


;;; Generated autoloads from lisp/obsolete/ess-r-a.el

(register-definition-prefixes "lisp/obsolete/ess-r-a" '("ess" "pd::set-up-demo"))
...

;;; Generated autoloads from lisp/obsolete/mouseme.el

(autoload 'mouse-me "lisp/obsolete/mouseme" "\
Popup a menu of functions to run on selected string or region.

(fn EVENT)" t)
(register-definition-prefixes "lisp/obsolete/mouseme" '("mouse-me-"))


;;; Generated autoloads from lisp/obsolete/msdos.el

(register-definition-prefixes "lisp/obsolete/msdos" '("explicit-msdos-" "msdos"))

;;; End of scraped data
